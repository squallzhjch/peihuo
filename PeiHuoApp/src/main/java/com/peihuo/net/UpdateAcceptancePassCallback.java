...
public class UpdateAcceptancePassCallback extends BaseCallback {
    ...
    public UpdateAcceptancePassCallback(Context activity, String code, String userId, OnUpdateDataListener listener) {
    ...
    protected void loadData() {
        Call<ResponseBody> call = NetManager.getInstance().getNetService().updateAcceptancePass(mCode, mUserId);
        showLoading(call);
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    MyLogManager.writeLogtoFile("数据库查询", "验收通过", res);
